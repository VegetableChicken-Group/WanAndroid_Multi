package com.ndhzs.lib.crash.dialog
...
import com.ndhzs.api.crash.view.ScaleScrollTextView
import com.ndhzs.lib.base.dailog.ChooseDialog
...
class CrashDialog private constructor(
  ...
  private val mScaleScrollTextView = ScaleScrollTextView(context, null).apply {
    ...
    setSideBackgroundColor(com.ndhzs.lib.config.R.color.config_dialog_bg.color)
  }
